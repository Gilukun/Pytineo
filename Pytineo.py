...
if sidebar=="Accueil":
    intro = st.container()
    image = Image.open("https://github.com/Gilukun/Pytineo/blob/main/Pytineo/Pytineo_logo_2.png")
    with intro:
        col1, col2, col3= st.columns([1,1,1])
        with col2:
            st.image(image, width=500,output_format="auto")
...
#---------------------
        ...
        with clean4:
            st.image("https://github.com/Gilukun/Pytineo/tree/main/Icones/search_dataset.png",width=60)
        with clean5:   
        ...
        with clean6:  
           st.image("https://github.com/Gilukun/Pytineo/tree/main/Icones/Analysis.png",width=60)
        with clean7: 
        ...
        with clean8:  
            st.image("https://github.com/Gilukun/Pytineo/tree/main/Icones/Clean.png",width=60)
        with clean9:
