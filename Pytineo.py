...
if sidebar=="Acceuil":
    ...
    with intro:
        ...
        with col2:
            st.image('https://github.com/Gilukun/Pytineo/blob/main/Pytineo_Logo_2.png', caption=None, width=700, use_column_width=700, clamp=False, channels="RGB", output_format="PNG")
