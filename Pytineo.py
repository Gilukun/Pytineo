...
if sidebar=="Analyse de données":
    ...
    df = pd.read_csv("https://github.com/Gilukun/Pytineo/blob/main/datatourisme.POI_OK_20210921.PACA.csv", low_memory=False)
...
#---------------------
        ...
        with clean4:
            st.image("Icones/search_dataset.png",width=60)
        with clean5:   
        ...
        with clean6:  
           st.image("Icones/Analysis.png",width=60)
        with clean7: 
        ...
        with clean8:  
            st.image("Icones/Clean.png",width=60)
        with clean9:
        ...
        with cat4:  
           st.image("Icones/URL.png",width=35)
        with cat5:
        ...
        with cat6:  
           st.image("Icones/dataset.png",width=35)
        with cat7:
        ...
        with cat8:  
           st.image("Icones/Associate.png",width=35)
        with cat9:
